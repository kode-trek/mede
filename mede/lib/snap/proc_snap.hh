 ...
 */
 ...
 if (v1 == "--jpg") {
  if (v3 == "") v3 = "100";
  v4 = uri(v2)[2] + "_JPEG_" + ts() + ".jpg";
 }
 if (v1 == "--pdf") v4 = uri(v2)[2] + "_PDF_" + ts() + ".pdf";
 if (v1 == "--mov") v4 = uri(v2)[2] + "_SLIDE_" + ts() + ".mp4";
 if (v1 == "--roll") v4 = "SCREEN-RECORD_" + ts();
 if (v1 == "--gif") v4 = uri(v2)[2] + "_GIF_" + ts() + ".gif";
 // message(s)
 string msg1 =
 out1 + v4 + "\n" +
