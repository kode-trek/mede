 ...
 */
 ...
 //
 sys(cmd1); v3 = str2num(cat(v2).txt); rm(v2);
 sys(cmd2); v4 = str2num(cat(v2).txt); rm(v2);
 sys(cmd3); v5 = str2num(cat(v2).txt); rm(v2);
 sys(cmd4); v6 = str2num(cat(v2).txt); rm(v2);
 sys(cmd5); v7 = str2num(cat(v2).txt); rm(v2);
 if (v9) {
